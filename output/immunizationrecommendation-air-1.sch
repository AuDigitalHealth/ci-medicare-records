...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:ImmunizationRecommendation/f:meta</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:ImmunizationRecommendation/f:patient</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:ImmunizationRecommendation/f:patient/f:identifier</sch:title>
    <sch:rule context="f:ImmunizationRecommendation/f:patient/f:identifier">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>ImmunizationRecommendation.recommendation.protocol</sch:title>
    <sch:rule context="f:ImmunizationRecommendation/f:recommendation/f:protocol">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
